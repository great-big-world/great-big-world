...
public class FungusHatFoliagePlacer extends FoliagePlacer {
    public static final Codec<FungusHatFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        return createCodec(instance).apply(instance, FungusHatFoliagePlacer::new);
    });
    protected final BlockStateProvider decorationState;

    protected static <P extends FungusHatFoliagePlacer> Products.P3<RecordCodecBuilder.Mu<P>, IntProvider, IntProvider, BlockStateProvider> createCodec(RecordCodecBuilder.Instance<P> builder) {
    ...
    public FungusHatFoliagePlacer(IntProvider radius, IntProvider offset, BlockStateProvider decorationState) {
        super(radius, offset);
    ...
    protected FoliagePlacerType<?> getType() {
        return PlacerRegistry.FUNGUS_HAT_FOLIAGE_PLACER;
    }
