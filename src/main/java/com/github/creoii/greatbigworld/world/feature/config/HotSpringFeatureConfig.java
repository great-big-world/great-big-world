...
public record HotSpringFeatureConfig(int yOffset, IntProvider rimSize, BlockStateProvider rimState, BlockStateProvider innerState, IntProvider height, IntProvider startRadius, IntProvider innerDepth, TagKey<Block> replaceable, boolean solidRim) implements FeatureConfig {
    public static final Codec<HotSpringFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> {
        ...
        })).apply(instance, HotSpringFeatureConfig::new);
    });
}
