...
public class SawmillScreenHandler extends ScreenHandler {
    ...
    public SawmillScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(GBWScreens.SAWMILL, syncId);
        int i;
    ...
    public boolean canUse(PlayerEntity player) {
        return SawmillScreenHandler.canUse(this.context, player, GBWBlocks.SAWMILL);
    }
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(GBWRecipes.SAWMILLING, input, this.world);
        }
    }
