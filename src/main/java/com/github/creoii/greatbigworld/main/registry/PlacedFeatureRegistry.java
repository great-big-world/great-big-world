...
public class PlacedFeatureRegistry implements Register {
    ...
    static {
        ...
        PATCH_DAYLIGHT_MUSHROOMS = PlacedFeatures.register("patch_daylight_mushrooms", ConfiguredFeatureRegistry.PATCH_DAYLIGHT_MUSHROOMS, RarityFilterPlacementModifier.of(12), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
        PATCH_DARKBLIGHT_MUSHROOMS = PlacedFeatures.register("patch_darkblight_mushrooms", ConfiguredFeatureRegistry.PATCH_DARKBLIGHT_MUSHROOMS, RarityFilterPlacementModifier.of(2), CountPlacementModifier.of(2), SquarePlacementModifier.of(), PlacedFeatures.BOTTOM_TO_120_RANGE, BiomePlacementModifier.of(), BlockFilterPlacementModifier.of(SkyVisiblePredicate.of(1f)));
    }
}
