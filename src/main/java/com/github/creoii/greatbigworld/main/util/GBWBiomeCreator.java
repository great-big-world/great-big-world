...
public class GBWBiomeCreator {
    public static Biome createAspenForest() {
        ...
        builder.feature(GenerationStep.Feature.VEGETAL_DECORATION, PlacedFeatureRegistry.TREES_ASPEN_MIXED);
