...
public abstract class TreeConfiguredFeaturesMixin {
    ...
    static {
        ...
        SWAMP_OAK = ConfiguredFeatures.register("swamp_oak_hanging_leaves", Feature.TREE, builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_OAK_LEAVES.getDefaultState(), 1, 3, .2f), new LeavesVineTreeDecorator(0.25F))).build());
        OAK = ConfiguredFeatures.register("oak_hanging_leaves", Feature.TREE, oak().decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_OAK_LEAVES.getDefaultState(), 1, 2, .2f))).build());
        BIRCH = ConfiguredFeatures.register("birch_hanging_leaves", Feature.TREE, birch().decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_BIRCH_LEAVES.getDefaultState(), 1, 2, .15f))).build());
        JUNGLE_TREE = ConfiguredFeatures.register("jungle_tree_hanging_leaves", Feature.TREE, jungle().decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_JUNGLE_LEAVES.getDefaultState(), 1, 3, .2f), new CocoaBeansTreeDecorator(0.2F), TrunkVineTreeDecorator.INSTANCE, new LeavesVineTreeDecorator(0.25F))).ignoreVines().build());
        JUNGLE_TREE_NO_VINE = ConfiguredFeatures.register("jungle_tree_no_vine_hanging_leaves", Feature.TREE, jungle().decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_JUNGLE_LEAVES.getDefaultState(), 1, 3, .2f))).ignoreVines().build());
        FANCY_OAK = ConfiguredFeatures.register("fancy_oak_hanging_leaves", Feature.TREE, fancyOak().decorators(List.of(new HangingLeavesTreeDecorator(BlockRegistry.HANGING_OAK_LEAVES.getDefaultState(), 1, 3, .2f))).build());
    }
}
