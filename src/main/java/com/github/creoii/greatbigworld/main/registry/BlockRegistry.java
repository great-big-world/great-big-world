...
public class BlockRegistry {
    ...
    public static final Block COBBLED_STRATA = new Block(FabricBlockSettings.copy(STRATA));
    public static final Block COBBLED_STRATA_SLAB = new SlabBlock(FabricBlockSettings.copy(COBBLED_STRATA));
    public static final Block COBBLED_STRATA_STAIRS = new StairsBlock(COBBLED_STRATA.getDefaultState(), FabricBlockSettings.copy(COBBLED_STRATA));
    public static final Block COBBLED_STRATA_WALL = new WallBlock(FabricBlockSettings.copy(COBBLED_STRATA));
    public static final Block STRATA_BRICKS = new Block(FabricBlockSettings.copy(STRATA));
    public static final Block STRATA_BRICK_SLAB = new SlabBlock(FabricBlockSettings.copy(STRATA_BRICKS));
    public static final Block STRATA_BRICK_STAIRS = new StairsBlock(STRATA_BRICKS.getDefaultState(), FabricBlockSettings.copy(STRATA_BRICKS));
    public static final Block STRATA_BRICK_WALL = new WallBlock(FabricBlockSettings.copy(STRATA_BRICKS));
    ...
    public static void register() {
        //if (GreatBigWorld.isLoaded("cavier_caves"))
        ...
        registerBlock(new Identifier(MOD_ID, "strata"), STRATA, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "cobbled_strata"), COBBLED_STRATA, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "cobbled_strata_slab"), COBBLED_STRATA_SLAB, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "cobbled_strata_stairs"), COBBLED_STRATA_STAIRS, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "cobbled_strata_wall"), COBBLED_STRATA_WALL, ItemGroup.DECORATIONS);
        registerBlock(new Identifier(MOD_ID, "strata_slab"), STRATA_SLAB, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "strata_stairs"), STRATA_STAIRS, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "strata_wall"), STRATA_WALL, ItemGroup.DECORATIONS);
        registerBlock(new Identifier(MOD_ID, "strata_bricks"), STRATA_BRICKS, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "strata_brick_slab"), STRATA_BRICK_SLAB, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "strata_brick_stairs"), STRATA_BRICK_STAIRS, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "strata_brick_wall"), STRATA_BRICK_WALL, ItemGroup.DECORATIONS);
        registerBlock(new Identifier(MOD_ID, "grassy_stone"), GRASSY_STONE, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(MOD_ID, "grassy_deepslate"), GRASSY_DEEPSLATE, ItemGroup.BUILDING_BLOCKS);
        ...
        //if (GreatBigWorld.isLoaded("fire_and_ice"))
        ...
        //if (GreatBigWorld.isLoaded("high_seas"))
        ...
        //if (GreatBigWorld.isLoaded("honeycomb"))
        ...
        //if (GreatBigWorld.isLoaded("magic_v_melee"))
        ...
        //if (GreatBigWorld.isLoaded("wonders_of_the_wild"))
