...
public class BlockRegistry {
    ...
    public static final Block AZALEA_FLOWER = new FlowerBlock(StatusEffects.REGENERATION, 9, FabricBlockSettings.copy(Blocks.DANDELION));
    ...
    public static final Block STRATA = new Block(FabricBlockSettings.copy(Blocks.STONE).mapColor(MapColor.BROWN));
    public static final Block STRATA_SLAB = new SlabBlock(FabricBlockSettings.copy(STRATA));
    public static final Block STRATA_STAIRS = new StairsBlock(STRATA.getDefaultState(), FabricBlockSettings.copy(STRATA));
    public static final Block STRATA_WALL = new WallBlock(FabricBlockSettings.copy(STRATA));
    ...
    public static final Block STRATA_DIRT = new Block(FabricBlockSettings.copy(Blocks.DIRT).strength(1.5f, 6f));
    public static final Block STONE_DIRT = new Block(FabricBlockSettings.copy(Blocks.DIRT).strength(1.5f, 6f));
    ...
    public static final Block DANDELION_FLUFF = null;
    ...
    public static final Block POLLEN_BOCK = new CrushableBlock(-1, FabricBlockSettings.of(Material.AGGREGATE).mapColor(MapColor.PALE_YELLOW).sounds(BlockSoundGroup.SAND).strength(.3f).suffocates((state, world, pos) -> false));
    //endregion

    //region Magic V Melee
    public static final Block SAWMILL = null;

    public static final Block SOUR_BERRY_BUSH = new BerryBushBlock(ItemRegistry.SOUR_BERRY);
    public static final Block BITTER_BERRY_BUSH = new BerryBushBlock(ItemRegistry.BITTER_BERRY);
    public static final Block PUNGENT_BERRY_BUSH = new BerryBushBlock(ItemRegistry.PUNGENT_BERRY);
    ...
    public static final Block STRIPPED_OAK_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block OAK_BRANCH = new PostBlock(STRIPPED_OAK_BRANCH, FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block STRIPPED_SPRUCE_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.SPRUCE_LOG));
    public static final Block SPRUCE_BRANCH = new PostBlock(STRIPPED_SPRUCE_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_BIRCH_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.BIRCH_LOG));
    public static final Block BIRCH_BRANCH = new PostBlock(STRIPPED_BIRCH_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_JUNGLE_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.JUNGLE_LOG));
    public static final Block JUNGLE_BRANCH = new PostBlock(STRIPPED_JUNGLE_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_DARK_OAK_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.DARK_OAK_LOG));
    public static final Block DARK_OAK_BRANCH = new PostBlock(STRIPPED_DARK_OAK_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_ACACIA_BRANCH = new PostBlock(null, FabricBlockSettings.copy(Blocks.ACACIA_LOG));
    public static final Block ACACIA_BRANCH = new PostBlock(STRIPPED_ACACIA_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_SAKURA_BRANCH = new PostBlock(null, FabricBlockSettings.copy(SAKURA_LOG));
    public static final Block SAKURA_BRANCH = new PostBlock(STRIPPED_SAKURA_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_PALO_VERDE_BRANCH = new PostBlock(null, FabricBlockSettings.copy(PALO_VERDE_LOG));
    public static final Block PALO_VERDE_BRANCH = new PostBlock(STRIPPED_PALO_VERDE_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_SEQUOIA_BRANCH = new PostBlock(null, FabricBlockSettings.copy(SEQUOIA_LOG));
    public static final Block SEQUOIA_BRANCH = new PostBlock(STRIPPED_SEQUOIA_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_MAHOGANY_BRANCH = new PostBlock(null, FabricBlockSettings.copy(MAHOGANY_LOG));
    public static final Block MAHOGANY_BRANCH = new PostBlock(STRIPPED_MAHOGANY_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block STRIPPED_ASPEN_BRANCH = new PostBlock(null, FabricBlockSettings.copy(ASPEN_LOG));
    public static final Block ASPEN_BRANCH = new PostBlock(STRIPPED_ASPEN_BRANCH, FabricBlockSettings.copy(ASPEN_LOG));
    //endregion
    ...
    public static void register() {
        ...
        //if (GreatBigWorld.isLoaded("cornucopia"))
        ...
        registerBlock(new Identifier(GreatBigWorld.MOD_ID, "sequoia_log"), SEQUOIA_LOG, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(GreatBigWorld.MOD_ID, "stripped_sequoia_log"), STRIPPED_SEQUOIA_LOG, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(GreatBigWorld.MOD_ID, "sequoia_planks"), SEQUOIA_PLANKS, ItemGroup.BUILDING_BLOCKS);
        registerBlock(new Identifier(GreatBigWorld.MOD_ID, "sequoia_leaves"), SEQUOIA_LEAVES, ItemGroup.DECORATIONS);
