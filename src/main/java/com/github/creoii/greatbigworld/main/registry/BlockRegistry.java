...
public class BlockRegistry implements Register {
    ...
    public static final Block MAHOGANY_LEAVES = new LeavesBlock(CBlockSettings.copyOf(Blocks.OAK_LEAVES).fireSettings(new BlockUtil.FireSettings(30, 60)));
    public static final Block MAHOGANY_SAPLING = new SaplingBlock(new MahoganySaplingGenerator(), CBlockSettings.copyOf(Blocks.JUNGLE_SAPLING));
    public static final Block POTTED_MAHOGANY_SAPLING = new FlowerPotBlock(MAHOGANY_SAPLING, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    //endregion
    //region Aspen Wood
    ...
    public static final Block YELLOW_ASPEN_LEAVES = new LeavesBlock(CBlockSettings.copyOf(Blocks.OAK_LEAVES).mapColor(MapColor.YELLOW).fireSettings(new BlockUtil.FireSettings(30, 60)));
    ...
    public static final Block GREEN_ASPEN_LEAVES = new LeavesBlock(CBlockSettings.copyOf(Blocks.OAK_LEAVES).fireSettings(new BlockUtil.FireSettings(30, 60)));
    public static final Block GREEN_ASPEN_LEAF_PILE = new LeafPileBlock(CBlockSettings.copyOf(YELLOW_ASPEN_LEAF_PILE).mapColor(MapColor.DARK_GREEN));
    public static final Block YELLOW_ASPEN_SAPLING = new SaplingBlock(new YellowAspenSaplingGenerator(), CBlockSettings.copyOf(Blocks.BIRCH_SAPLING));
    public static final Block POTTED_YELLOW_ASPEN_SAPLING = new FlowerPotBlock(YELLOW_ASPEN_SAPLING, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    public static final Block GREEN_ASPEN_SAPLING = new SaplingBlock(new GreenAspenSaplingGenerator(), CBlockSettings.copyOf(Blocks.BIRCH_SAPLING));
    public static final Block POTTED_GREEN_ASPEN_SAPLING = new FlowerPotBlock(GREEN_ASPEN_SAPLING, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    //endregion
    ...
    public static final Block POTTED_BAMBOO_TORCH = new FlowerPotBlock(BAMBOO_TORCH, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    public static final Block POTTED_SOUL_BAMBOO_TORCH = new FlowerPotBlock(SOUL_BAMBOO_TORCH, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    //endregion
    ...
    public static final Block COBBLESTONE_BRICKS = new Block(CBlockSettings.copyOf(Blocks.COBBLESTONE));
    public static final Block COBBLESTONE_BRICK_STAIRS = new StairsBlock(COBBLESTONE_BRICKS.getDefaultState(), CBlockSettings.copyOf(Blocks.COBBLESTONE_STAIRS));
    public static final Block COBBLESTONE_BRICK_SLAB = new SlabBlock(CBlockSettings.copyOf(Blocks.COBBLESTONE_SLAB));
    public static final Block COBBLESTONE_BRICK_WALL = new WallBlock(CBlockSettings.copyOf(Blocks.COBBLESTONE_WALL));
    public static final Block MOSSY_COBBLESTONE_BRICKS = new Block(CBlockSettings.copyOf(Blocks.MOSSY_COBBLESTONE));
    public static final Block MOSSY_COBBLESTONE_BRICK_STAIRS = new StairsBlock(MOSSY_COBBLESTONE_BRICKS.getDefaultState(), CBlockSettings.copyOf(Blocks.MOSSY_COBBLESTONE_STAIRS));
    public static final Block MOSSY_COBBLESTONE_BRICK_SLAB = new SlabBlock(CBlockSettings.copyOf(Blocks.MOSSY_COBBLESTONE_SLAB));
    public static final Block MOSSY_COBBLESTONE_BRICK_WALL = new WallBlock(CBlockSettings.copyOf(Blocks.MOSSY_COBBLESTONE_WALL));
    //endregion
    //region Stained Calcite
    public static final Block BROWN_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_BROWN));
    public static final Block RED_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_RED));
    public static final Block ORANGE_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_ORANGE));
    public static final Block YELLOW_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_YELLOW));
    public static final Block LIME_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_LIME));
    public static final Block GREEN_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_GREEN));
    public static final Block CYAN_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_CYAN));
    public static final Block BLUE_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_BLACK));
    public static final Block LIGHT_BLUE_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE));
    public static final Block PINK_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_PINK));
    public static final Block MAGENTA_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_MAGENTA));
    public static final Block PURPLE_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_PURPLE));
    public static final Block BLACK_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_BLACK));
    public static final Block GRAY_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_GRAY));
    public static final Block LIGHT_GRAY_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY));
    public static final Block WHITE_STAINED_CALCITE = new Block(CBlockSettings.copyOf(Blocks.CALCITE).mapColor(MapColor.TERRACOTTA_RED));
    //endregion
    //region Thatch
    ...
    public static final Block BEACHGRASS_THATCH = new ThatchBlock(CBlockSettings.copyOf(TRIMMED_BEACHGRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_BEACHGRASS_THATCH);
    public static final Block TRIMMED_BEACHGRASS_THATCH_STAIRS = new StairsBlock(TRIMMED_BEACHGRASS_THATCH.getDefaultState(), CBlockSettings.copyOf(TRIMMED_BEACHGRASS_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block BEACHGRASS_THATCH_STAIRS = new ThatchStairsBlock(CBlockSettings.copyOf(BEACHGRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), BEACHGRASS_THATCH.getDefaultState(), TRIMMED_BEACHGRASS_THATCH_STAIRS);
    public static final Block TRIMMED_BEACHGRASS_THATCH_SLAB = new SlabBlock(CBlockSettings.copyOf(TRIMMED_BEACHGRASS_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block BEACHGRASS_THATCH_SLAB = new ThatchSlabBlock(CBlockSettings.copyOf(BEACHGRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_BEACHGRASS_THATCH_SLAB);
    ...
    public static final Block BAMBOO_THATCH = new ThatchBlock(CBlockSettings.copyOf(TRIMMED_BAMBOO_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_BAMBOO_THATCH);
    public static final Block TRIMMED_BAMBOO_THATCH_STAIRS = new StairsBlock(TRIMMED_BAMBOO_THATCH.getDefaultState(), CBlockSettings.copyOf(TRIMMED_BAMBOO_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block BAMBOO_THATCH_STAIRS = new ThatchStairsBlock(CBlockSettings.copyOf(BAMBOO_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), BAMBOO_THATCH.getDefaultState(), TRIMMED_BAMBOO_THATCH_STAIRS);
    public static final Block TRIMMED_BAMBOO_THATCH_SLAB = new SlabBlock(CBlockSettings.copyOf(TRIMMED_BAMBOO_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block BAMBOO_THATCH_SLAB = new ThatchSlabBlock(CBlockSettings.copyOf(BAMBOO_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_BAMBOO_THATCH_SLAB);
    ...
    public static final Block GRASS_THATCH = new ThatchBlock(CBlockSettings.copyOf(TRIMMED_GRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_GRASS_THATCH);
    public static final Block TRIMMED_GRASS_THATCH_STAIRS = new StairsBlock(TRIMMED_GRASS_THATCH.getDefaultState(), CBlockSettings.copyOf(TRIMMED_GRASS_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block GRASS_THATCH_STAIRS = new ThatchStairsBlock(CBlockSettings.copyOf(GRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), GRASS_THATCH.getDefaultState(), TRIMMED_GRASS_THATCH_STAIRS);
    public static final Block TRIMMED_GRASS_THATCH_SLAB = new SlabBlock(CBlockSettings.copyOf(TRIMMED_GRASS_THATCH).fireSettings(new BlockUtil.FireSettings(70, 140)));
    public static final Block GRASS_THATCH_SLAB = new ThatchSlabBlock(CBlockSettings.copyOf(GRASS_THATCH).fireSettings(new BlockUtil.FireSettings(80, 160)), TRIMMED_GRASS_THATCH_SLAB);
    //endregion
    //region Lavarock
    public static final Block VOLCANIC_SAND = new SandBlock(2827557, CBlockSettings.copyOf(Blocks.SAND).mapColor(MapColor.BLACK));
    public static final Block LAVAROCK = new Block(CBlockSettings.copyOf(Blocks.STONE).mapColor(MapColor.BLACK));
    public static final Block GRASSY_LAVAROCK = new GrassBlock(CBlockSettings.copyOf(LAVAROCK).ticksRandomly().sounds(BlockSoundGroup.GRASS));
    public static final Block LAVAROCK_STAIRS = new StairsBlock(LAVAROCK.getDefaultState(), CBlockSettings.copyOf(LAVAROCK));
    public static final Block LAVAROCK_SLAB = new SlabBlock(CBlockSettings.copyOf(LAVAROCK));
    public static final Block LAVAROCK_WALL = new WallBlock(CBlockSettings.copyOf(LAVAROCK));
    public static final Block LAVAROCK_BRICKS = new Block(CBlockSettings.copyOf(Blocks.STONE_BRICKS).mapColor(MapColor.BLACK));
    public static final Block LAVAROCK_BRICK_STAIRS = new StairsBlock(LAVAROCK_BRICKS.getDefaultState(), CBlockSettings.copyOf(LAVAROCK_BRICKS));
    public static final Block LAVAROCK_BRICK_SLAB = new SlabBlock(CBlockSettings.copyOf(LAVAROCK_BRICKS));
    public static final Block LAVAROCK_BRICK_WALL = new WallBlock(CBlockSettings.copyOf(LAVAROCK_BRICKS));
    //endregion
    //region Acai
    ...
    public static final Block ACAI_LEAVES = new LeavesBlock(CBlockSettings.copyOf(Blocks.JUNGLE_LEAVES).fireSettings(new BlockUtil.FireSettings(30, 60)));
    public static final Block HANGING_ACAI_LEAVES = new HangingLeavesBlock(CBlockSettings.copyOf(ACAI_LEAVES).fireSettings(new BlockUtil.FireSettings(30, 60)));
    public static final Block ACAI_SAPLING = new SaplingBlock(new AcaiSaplingGenerator(), CBlockSettings.copyOf(MAHOGANY_SAPLING));
    public static final Block POTTED_ACAI_SAPLING = new FlowerPotBlock(ACAI_SAPLING, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    public static final Block ACAI_BERRY_CLUMP = new AcaiBerryClumpBlock(CBlockSettings.copyOf(Blocks.MUSHROOM_STEM).mapColor(MapColor.TERRACOTTA_PURPLE).ticksRandomly());
    //endregion
    //region Elder Prismarine
    public static final Block ELDER_PRISMARINE = new Block(CBlockSettings.copyOf(Blocks.PRISMARINE).mapColor(MapColor.PALE_YELLOW));
    public static final Block ELDER_PRISMARINE_SLAB = new SlabBlock(CBlockSettings.copyOf(ELDER_PRISMARINE));
    public static final Block ELDER_PRISMARINE_STAIRS = new StairsBlock(ELDER_PRISMARINE.getDefaultState(), CBlockSettings.copyOf(ELDER_PRISMARINE));
    public static final Block ELDER_PRISMARINE_WALL = new WallBlock(CBlockSettings.copyOf(ELDER_PRISMARINE));
    public static final Block ELDER_PRISMARINE_BRICKS = new Block(CBlockSettings.copyOf(Blocks.PRISMARINE_BRICKS).mapColor(MapColor.PALE_YELLOW));
    public static final Block ELDER_PRISMARINE_BRICK_SLAB = new SlabBlock(CBlockSettings.copyOf(ELDER_PRISMARINE_BRICKS));
    public static final Block ELDER_PRISMARINE_BRICK_STAIRS = new StairsBlock(ELDER_PRISMARINE_BRICKS.getDefaultState(), CBlockSettings.copyOf(ELDER_PRISMARINE_BRICKS));
    public static final Block ELDER_PRISMARINE_BRICK_WALL = new WallBlock(CBlockSettings.copyOf(ELDER_PRISMARINE_BRICKS));
    public static final Block ELDER_SEA_LANTERN = new Block(CBlockSettings.copyOf(Blocks.SEA_LANTERN).mapColor(MapColor.PALE_YELLOW).luminance(state -> 14));
    //endregion
    //region Miscellaneous
    public static final Block ANTLER = new AntlerBlock();
    public static final Block TALL_HEATHER = new TallFlowerBlock(CBlockSettings.copyOf(Blocks.ROSE_BUSH).fireSettings(new BlockUtil.FireSettings(60, 100)));
    public static final Block HEATHER = new FernBlock(CBlockSettings.copyOf(Blocks.POPPY).fireSettings(new BlockUtil.FireSettings(60, 100)));
    public static final Block POTTED_HEATHER = new FlowerPotBlock(HEATHER, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    ...
    public static final Block POTTED_BEACHGRASS = new FlowerPotBlock(BEACHGRASS, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    public static final Block TROPICAL_FERN = new FernBlock(CBlockSettings.copyOf(Blocks.FERN).fireSettings(new BlockUtil.FireSettings(60, 100)));
    public static final Block LARGE_TROPICAL_FERN = new TallPlantBlock(CBlockSettings.copyOf(Blocks.LARGE_FERN).fireSettings(new BlockUtil.FireSettings(60, 100)));
    public static final Block POTTED_TROPICAL_FERN = new FlowerPotBlock(TROPICAL_FERN, CBlockSettings.copyOf(Blocks.FLOWER_POT));
    public static final Block NAUTILUS_FOSSIL = new Block(CBlockSettings.copyOf(Blocks.STONE));
    //endregion
