...
public class ConfiguredFeatureRegistry implements Register {
    ...
    static {
        ...
        PATCH_DAYLIGHT_MUSHROOMS = ConfiguredFeatures.register("patch_daylight_mushrooms", Feature.RANDOM_PATCH, ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(BlockRegistry.DAYLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 1), 6).add(BlockRegistry.DAYLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 2), 4).add(BlockRegistry.DAYLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 3), 2).build())), List.of(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL)));
        PATCH_DARKBLIGHT_MUSHROOMS = ConfiguredFeatures.register("patch_darkblight_mushrooms", Feature.RANDOM_PATCH, ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(BlockRegistry.DARKBLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 1), 6).add(BlockRegistry.DARKBLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 2), 4).add(BlockRegistry.DARKBLIGHT_MUSHROOM.getDefaultState().with(GlimmeringMushroomBlock.MUSHROOMS, 3), 2).build())), List.of(Blocks.STONE, Blocks.DEEPSLATE, Blocks.GRANITE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.OAK_PLANKS, Blocks.DIRT, Blocks.TUFF, Blocks.CALCITE)));
    }
}
