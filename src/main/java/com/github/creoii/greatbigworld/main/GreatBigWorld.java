...
public class GreatBigWorld implements ModInitializer {
    ...
    public static final Map<Block, Block> HEAT_CONVERSIONS = new ImmutableMap.Builder<Block, Block>()
            ...
            .put(GBWBlocks.COBBLESTONE_BRICKS, GBWBlocks.RED_ROCK_BRICKS)
            .put(GBWBlocks.COBBLESTONE_BRICK_STAIRS, GBWBlocks.RED_ROCK_BRICK_STAIRS)
            .put(GBWBlocks.COBBLESTONE_BRICK_SLAB, GBWBlocks.RED_ROCK_BRICK_SLAB)
            .put(GBWBlocks.COBBLESTONE_BRICK_WALL, GBWBlocks.RED_ROCK_BRICK_WALL)
