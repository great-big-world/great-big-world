...
public class ParticleRegistry implements Register {
    ...
    public void register() {
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(GreatBigWorld.NAMESPACE, "day_glimmer"), DAY_GLIMMER);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(GreatBigWorld.NAMESPACE, "night_glimmer"), NIGHT_GLIMMER);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(GreatBigWorld.NAMESPACE, "dark_glimmer"), DARK_GLIMMER);
    }
