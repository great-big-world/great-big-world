...
import com.github.creoii.greatbigworld.world.feature.StructureSupportFeature;
...
import com.github.creoii.greatbigworld.world.feature.config.StructureSupportFeatureConfig;
...
public class FeatureRegistry implements Register {
    ...
    public static final Feature<StructureSupportFeatureConfig> STRUCTURE_SUPPORT = new StructureSupportFeature(StructureSupportFeatureConfig.CODEC);
    ...
    public void register() {
        ...
        Registry.register(Registries.FEATURE, new Identifier(GreatBigWorld.NAMESPACE, "structure_support"), STRUCTURE_SUPPORT);
    }
}
